            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[570px] text-center">
                ...
                <p className="mx-auto mb-6 max-w-[515px] text-base leading-[1.5] text-white">
                  Our team of expert coaches, mentors, and managers brings
                  top-level experience and dedication to every athlete. Join a
                  community where potential is realized and goals become wins.
                </p>
                <Link
                  href="/"
